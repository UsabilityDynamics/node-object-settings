 ...
 *
 */
function Settings( config, defaults ) {
...
Object.defineProperties( module.exports = Settings, {
  ...
  "defaults": {
    ...
    value: function defaults( data ) {
      Abstract._meta = Abstract._meta || { enumerable: true, writable: true, configurable: true };
      return data ? Abstract._meta.defaults = data : Abstract._meta.defaults = Abstract._meta.defaults || {};
    },
    writable: false,
    "enumerable": false
  }
